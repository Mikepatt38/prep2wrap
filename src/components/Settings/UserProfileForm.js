...
export class UserProfileForm extends Component {
  state = {
    ...
    bilingual: this.props.currentUser.profileInformation && this.props.currentUser.profileInformation.bilingual ? this.props.currentUser.profileInformation.bilingual : false, 
    languages: this.props.currentUser.profileInformation && this.props.currentUser.profileInformation.languages ? this.props.currentUser.profileInformation.languages : [],
    travel: this.props.currentUser.profileInformation && this.props.currentUser.profileInformation.travel ? this.props.currentUser.profileInformation.travel : false, 
    union: this.props.currentUser.profileInformation && this.props.currentUser.profileInformation.union ? this.props.currentUser.profileInformation.union : false, 
    unions: this.props.currentUser.profileInformation && this.props.currentUser.profileInformation.unions ? this.props.currentUser.profileInformation.unions : [],
